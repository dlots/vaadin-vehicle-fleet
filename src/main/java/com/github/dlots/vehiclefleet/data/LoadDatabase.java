...
//            service.saveDrivers(driver1, driver2, unemployed, driver3, driver4, driver5, driver6);
            ...
            service.saveVehicleModel(chrysler);
            service.saveVehicleModel(harley);

//            Vehicle car1 = new Vehicle(chrysler, enterprise1, List.of(driver1), driver1, "vin__enterprise_1", 2000, 1982, 100000);
//            service.saveVehicle(car1);
//            Vehicle bike1 = new Vehicle(harley, enterprise1, List.of(driver2), driver2,"vin__enterprise_1", 3500, 1987, 30000);
//            service.saveVehicle(bike1);
//
//            Vehicle car2 = new Vehicle(chrysler, enterprise2, List.of(driver3), driver3, "vin__enterprise_2", 2000, 1982, 100000);
//            service.saveVehicle(car2);
//            Vehicle bike2 = new Vehicle(harley, enterprise2, List.of(driver4), driver4,"vin__enterprise_2", 3500, 1987, 30000);
//            service.saveVehicle(bike2);
//
//            Vehicle car3 = new Vehicle(chrysler, enterprise3, List.of(driver5), driver5, "vin__enterprise_3", 2000, 1982, 100000);
//            service.saveVehicle(car3);
//            Vehicle bike3 = new Vehicle(harley, enterprise3, List.of(driver6), driver6,"vin__enterprise_3", 3500, 1987, 30000);
